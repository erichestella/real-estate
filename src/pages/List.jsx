...
import heroImage from '../assets/download-2.jpeg';
import cardImage from '../assets/download-3.png';
import './List.css';

// Slides for the left column — replaces "client testimonials" (as used on
// the Book Viewing page) with a quick explainer of how listing a property
// on Your RealState actually works.
const howItWorks = [
  {
    title: 'Submit Your Details',
    description: "Tell us about your property — type, location, price, and photos. It only takes a few minutes to get started.",
  },
  {
    title: 'We Review & Verify',
    description: 'Our licensed brokers carefully review every submission to make sure it\'s ready to attract serious buyers.',
  },
  {
    title: 'Your Listing Goes Live',
    description: "Your property gets featured across our curated listings, interactive map, and buyer network.",
  },
  {
    title: 'Meet Your Buyer',
    description: 'Interested buyers can book a private viewing directly, and we handle the coordination from there.',
  },
];
...
export default function List() {
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      setSlide((prev) => (prev + 1) % howItWorks.length)
    }, 5000)
  ...
  return (
    <div className="list-prop">
      ...
      <div
        className="list-prop__bg"
        style={{ backgroundImage: `url(${heroImage})` }}
        aria-hidden="true"
      />

      <div className="list-prop__row">
        {/* Left: text straight over the photo, no card */}
        <aside className="list-prop__side">
          <h2 className="list-prop__side-title">List Your <span>Property</span></h2>
          <p className="list-prop__side-copy">
            Feature your luxury home or estate to high-end buyers across Metro Manila.
          </p>

          <div className="list-prop__slider">
            <div
              className="list-prop__slider-track"
              style={{ transform: `translateX(-${slide * 100}%)` }}
            >
              {howItWorks.map((step, i) => (
                <div className="list-prop__slide" key={step.title}>
                  <p className="list-prop__step-number">Step {i + 1}</p>
                  <p className="list-prop__step-title">{step.title}</p>
                  <p className="list-prop__step-desc">{step.description}</p>
                </div>
              ))}
            </div>
          </div>

          <div className="list-prop__dots">
            {howItWorks.map((step, i) => (
              <button
                key={step.title}
                type="button"
        ...
        <main className="list-prop__panel">
          <div className="list-prop__card">
            <h1 className="list-prop__title">Sell Your Property</h1>

            <p className="list-prop__intro">Your next chapter starts here.</p>
            <p className="list-prop__intro">
              Selling a property isn't just a transaction — it's a big decision,
              and we're here to make it seamless.
            </p>
            <p className="list-prop__intro">
              Share your property details below, and our brokers will confidentially
              review it for possible inclusion in our curated listings.
            </p>

            <img
              className="list-prop__image"
              src={cardImage}
              alt="Exterior of a featured property"
            />

            <p className="list-prop__form-note">
